...
class MedicalFormWizardPage extends StatefulWidget {
  const MedicalFormWizardPage({Key? key}) : super(key: key);

  @override
  State<MedicalFormWizardPage> createState() => _MedicalFormWizardPageState();
}

class _MedicalFormWizardPageState extends State<MedicalFormWizardPage> {
  int currentStep = 0;
