...
class _PatientStateState extends State<PatientState> {
  ...
  Widget _buildBackButton(BuildContext context, ThemeData theme) {
    return ElevatedButton.icon(
      ...
      label: const Text(PatientStateConstants.backButtonText),
      style: ElevatedButton.styleFrom(
        backgroundColor: theme.colorScheme.primary,
        foregroundColor: theme.colorScheme.onPrimary,
        padding: const EdgeInsets.symmetric(
          horizontal: PatientStateConstants.buttonHorizontalPadding,
          vertical: PatientStateConstants.buttonVerticalPadding,
        ),
        textStyle: const TextStyle(
          fontSize: PatientStateConstants.buttonFontSize,
  ...
  /// Handles back navigation with error handling
  void _handleBackNavigation(BuildContext context) {
    try {
      Navigator.of(context).pop();
    } catch (e) {
      _showErrorSnackBar('فشل في العودة للصفحة السابقة');
    }
  }
